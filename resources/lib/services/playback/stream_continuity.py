...
from resources.lib.common.cache_utils import CACHE_MANIFESTS, generate_identifier
...
class StreamContinuityManager(PlaybackActionManager):
    ...
    def _show_only_forced_subtitle(self):
        ...
        if self.legacy_kodi_version:
            ...
            cache_identifier = generate_identifier(g.get_esn() + '_' + self.current_videoid.value)
